...
export default function AsyncWait() {
    ...
    useEffect(() => {
        console.log("AyncWait: ", getUserData());
        (async function() {
           const userOne = await getUserData();
           console.log("user One: ", userOne);
           const userTwo = await getUserData();
           console.log("user Two: ", userTwo);
           const userThree = await getUserData();
